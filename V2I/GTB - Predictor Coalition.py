...
x=[6,15,11,17,12,13,7,14,10,8,9,16] #Predictors
...
gtb_regressor = GradientBoostingRegressor(n_estimators=70, learning_rate=0.14, max_depth=10, min_samples_leaf=10, alpha=0.9, random_state=42, loss='absolute_error', max_features='auto')
gtb_regressor.fit(X_train, np.ravel(y_train))
