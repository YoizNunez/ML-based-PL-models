...
ax2.grid(ls='--')
ax2.set_xlabel('$n_b$',fontsize=34)
...
ax3.grid(ls='--')
ax3.set_xlabel('$\sigma_b$ (m)',fontsize=34)
...
ax4.set_xlabel('$n_v$',fontsize=34)
#ax4.set_ylabel('(d)',fontsize=18)
ax4.xaxis.set_tick_params(labelsize=34)
ax4.yaxis.set_tick_params(labelsize=34)
...
ax5.grid(ls='--')
ax5.set_xlabel('$\sigma_v$ (m)',fontsize=34)
#ax5.set_ylabel('(e)',fontsize=18)
#ax5.set_title('(e)',size=32)
ax5.xaxis.set_tick_params(labelsize=34)
ax5.yaxis.set_tick_params(labelsize=34)
...
ax6.grid(ls='--')
ax6.set_xlabel('$\sigma_g$ (m)',fontsize=34)
#ax6.set_ylabel('(f)',fontsize=18)
ax6.xaxis.set_tick_params(labelsize=34)
ax6.yaxis.set_tick_params(labelsize=34)
...
ax7.grid(ls='--')
ax7.set_xlabel('$d$ (m)',fontsize=34)
ax7.xaxis.set_tick_params(labelsize=34)
ax7.yaxis.set_tick_params(labelsize=34)
...
fig.supylabel('Centered Accumulated Local Effect',fontsize=40,fontweight=20,x=0.02)
#fig.tight_layout()
...
#f
ax1.plot(df['ale_f_bin_s1'],df['ale_f_value_s1'],"+-", label ='1',lw=8,color='blue')
ax1.plot(df['ale_f_bin_s2'],df['ale_f_value_s2'],"-.", label ='2',lw=8,color='red')
ax1.plot(df['ale_f_bin_s3'],df['ale_f_value_s3'],"--", label ='3',lw=8,color='green')
ax1.plot(df['ale_f_bin_s4'],df['ale_f_value_s4'],":",label ='4',lw=8,color='orange')
ax1.plot(df['ale_f_bin_s5'],df['ale_f_value_s5'],"x-", label ='5',lw=8,color='brown')
ax1.plot(df['ale_f_bin_s6'],df['ale_f_value_s6'], label ='6',lw=8,color='purple')
ax1.plot(df['ale_f_bin_s7'],df['ale_f_value_s7'], label ='7',lw=8,color='black')
ax1.grid(ls='--')
ax1.set_xlabel('$f$ (GHz)',fontsize=41)
#ax1.set_title('(a)',size=40)
#ax1.set_ylabel('(a)',fontsize=18)
ax1.xaxis.set_tick_params(labelsize=41)
ax1.yaxis.set_tick_params(labelsize=41)
ax1.legend(loc='upper left',fancybox=False,shadow=False,fontsize="25")
x_labels1 = ['','0.73','2.5','3.5']
ax1.set_xticklabels(x_labels1)
...
#nb
ax2.plot(df['ale_nb_bin_s2'],df['ale_nb_value_s2'],"-.", label ='2',lw=8,color='red')
ax2.plot(df['ale_nb_bin_s3'],df['ale_nb_value_s3'],"-.", label ='3',lw=8,color='green')
ax2.plot(df['ale_nb_bin_s4'],df['ale_nb_value_s4'],"--", label ='4',lw=8,color='orange')
ax2.plot(df['ale_nb_bin_s5'],df['ale_nb_value_s5'],":", label ='5',lw=8,color='brown')
ax2.plot(df['ale_nb_bin_s6'],df['ale_nb_value_s6'],"x-", label ='6',lw=8,color='purple')
ax2.plot(df['ale_nb_bin_s7'],df['ale_nb_value_s7'], label ='7',lw=8,color='black')
#ax2.set_title('(b)',size=40)
ax2.grid(ls='--')
ax2.set_xlabel('$n_b$',fontsize=41)
#ax2.set_ylabel('(b)',fontsize=18)
ax2.xaxis.set_tick_params(labelsize=41)
ax2.yaxis.set_tick_params(labelsize=41)
ax2.legend(fancybox=False,shadow=False,fontsize="25")
x_labels2 = ['4','8','12','16']
ax2.set_xticklabels(x_labels2)
...
df = pd.read_csv(path)
#sb
ax3.plot(df['ale_sb_bin_s3'],df['ale_sb_value_s3'],"--", label ='3',lw=8,color='green')
ax3.plot(df['ale_sb_bin_s4'],df['ale_sb_value_s4'],"--", label ='4',lw=8,color='orange')
ax3.plot(df['ale_sb_bin_s5'],df['ale_sb_value_s5'],":", label ='5',lw=8,color='brown')
ax3.plot(df['ale_sb_bin_s6'],df['ale_sb_value_s6'],"x-", label ='6',lw=8,color='purple')
ax3.plot(df['ale_sb_bin_s7'],df['ale_sb_value_s7'], label ='7',lw=8,color='black')
ax3.grid(ls='--')
ax3.set_xlabel('$\sigma_b$ (m)',fontsize=41)
#ax3.set_title('(c)',size=40)
#ax3.set_ylabel('(c)',fontsize=18)
ax3.xaxis.set_tick_params(labelsize=41)
ax3.yaxis.set_tick_params(labelsize=41)
ax3.legend(loc='lower right',fancybox=False,shadow=False,fontsize="25")
x_labels3 = ['2.17','6.29','10.41','14.54','18.66']
ax3.set_xticklabels(x_labels3)
...
ax4.plot(df['ale_nv_bin_s4'],df['ale_nv_value_s4'],":", label ='4',lw=8,color='orange')
ax4.plot(df['ale_nv_bin_s5'],df['ale_nv_value_s5'],":", label ='5',lw=8,color='brown')
ax4.plot(df['ale_nv_bin_s6'],df['ale_nv_value_s6'],"x-", label ='6',lw=8,color='purple')
ax4.plot(df['ale_nv_bin_s7'],df['ale_nv_value_s7'], label ='7',lw=8,color='black')
ax4.grid(ls='--')
#ax4.set_title('(d)',size=40)
ax4.set_xlabel('$n_v$',fontsize=41)
#ax4.set_ylabel('(d)',fontsize=18)
ax4.xaxis.set_tick_params(labelsize=41)
ax4.yaxis.set_tick_params(labelsize=41)
ax4.legend(fancybox=False,shadow=False,fontsize="25")
x_labels4 = ['0','2','4','6','8']
ax4.set_xticklabels(x_labels4)
...
ax5.plot(df['ale_sv_bin_s5'],df['ale_sv_value_s5'],"x-", label ='5',lw=8,color='brown')
ax5.plot(df['ale_sv_bin_s6'],df['ale_sv_value_s6'],"x-", label ='6',lw=8,color='purple')
ax5.plot(df['ale_sv_bin_s7'],df['ale_sv_value_s7'], label ='7',lw=8,color='black')
ax5.grid(ls='--')
ax5.set_xlabel('$\sigma_v$ (m)',fontsize=41)
#ax5.set_ylabel('(e)',fontsize=18)
#ax5.set_title('(e)',size=40)
ax5.xaxis.set_tick_params(labelsize=41)
ax5.yaxis.set_tick_params(labelsize=41)
ax5.legend(fancybox=False,shadow=False,fontsize="25")
x_labels5 = ['0','2.95','5.90','8.85','11.81']
ax5.set_xticklabels(x_labels5)
...
ax6.plot(df['ale_sg_bin_s6'],df['ale_sg_value_s6'], label ='6',lw=8,color='purple')
ax6.plot(df['ale_sg_bin_s7'],df['ale_sg_value_s7'], label ='7',lw=8,color='black')
ax6.grid(ls='--')
ax6.set_xlabel('$\sigma_g$ (m)',fontsize=41)
#ax6.set_ylabel('(f)',fontsize=18)
ax6.xaxis.set_tick_params(labelsize=41)
ax6.yaxis.set_tick_params(labelsize=41)
#ax6.set_title('(f)',size=40)
ax6.legend(fancybox=False,shadow=False,fontsize="25")
x_labels6 = ['0.82','1.63','2.45','3.26']
ax6.set_xticklabels(x_labels6)
...
ax7.plot(df['ale_d_bin_s7'],df['ale_d_value_s7'], label ='7',lw=8,color='black')
ax7.grid(ls='--')
ax7.set_xlabel('$d$ (m)',fontsize=40)
ax7.xaxis.set_tick_params(labelsize=40)
ax7.yaxis.set_tick_params(labelsize=40)
ax7.legend(fancybox=False,shadow=False,fontsize="25")
#ax7.set_title('(g)',size=40)
#x_labels4 = ['15','24.5','34.0','43.5','53.0']
#ax4.set_xticklabels(x_labels4)
x_labels7 = ['69.8','138.4','206.9','275.5']
ax7.set_xticklabels(x_labels7)
...
#plt.figtext(0.5, 0.97, 'Route #1', ha='center', va='center',fontsize='14')
#plt.figtext(0.5, 0.46, 'Route #2', ha='center', va='center',fontsize='14')


fig.supylabel('Centered Accumulated Local Effect',fontsize=52,fontweight=20,x=0.01)
...
plt.plot(x,RMSE_delta,'-o',linewidth=2.2,label='$\Delta RMSE_p$ [dB]')
plt.plot(x,IAS,'-o',linewidth=2.2,label='$\Delta IAS_p$')
plt.plot(x,MEC,'-o',linewidth=2.2,label='$\Delta MEC_p$')

plt.grid(ls='--')
plt.legend()
plt.xlabel('Colaitions',fontsize=12)
