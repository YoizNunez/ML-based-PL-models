...
p1 = 180
p2 = min(min(df["pl_target"]), min(df["pl_target"]))
ax1.plot([p1, p2], [p1, p2], '--',linewidth=1.5,label= 'Best fit',c='navy')
ax2.plot([p1, p2], [p1, p2], '--',linewidth=1.5,label= 'Best fit',c='navy')
ax3.plot([p1, p2], [p1, p2], '--',linewidth=1.5,label= 'Best fit',c='navy')
ax4.plot([p1, p2], [p1, p2], '--',linewidth=1.5,label= 'Best fit',c='navy')
...
ax1.set_xlabel('Measured PL [dB]',fontsize=20)
ax1.set_ylabel('Predicted PL [dB]',fontsize=20)
ax1.set_title('(a) ANN', fontsize=20)

ax2.set_xlabel('Measured PL [dB]',fontsize=20)
ax2.set_ylabel('Predicted PL [dB]',fontsize=20)
ax2.set_title('(b) SVR', fontsize=20)

ax3.set_xlabel('Measured PL [dB]',fontsize=20)
ax3.set_ylabel('Predicted PL [dB]',fontsize=20)
ax3.set_title('(c) RF', fontsize=20)

ax4.set_xlabel('Measured PL [dB]',fontsize=20)
ax4.set_ylabel('Predicted PL [dB]',fontsize=20)
