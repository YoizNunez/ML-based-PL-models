...
path=r"C:\Users\Yoiz Nuñez\Documents\DOUTORADO 2023\Plot - ALE - Macrocell\ALE-bh.csv"
df = pd.read_csv(path)

#bd
ax1.plot(df['ale_bd_bin_s1'],df['ale_bd_value_s1'],"+-", label ='1',lw=3,color='blue')
ax1.plot(df['ale_bd_bin_s2'],df['ale_bd_value_s2'],"-.", label ='2',lw=3,color='red')
ax1.plot(df['ale_bd_bin_s3'],df['ale_bd_value_s3'],"--", label ='3',lw=3,color='green')
ax1.plot(df['ale_bd_bin_s4'],df['ale_bd_value_s4'],":",label ='4',lw=5,color='orange')
ax1.plot(df['ale_bd_bin_s5'],df['ale_bd_value_s5'],"x-", label ='5',lw=3,color='brown')
ax1.plot(df['ale_bd_bin_s6'],df['ale_bd_value_s6'], label ='6',lw=3,color='purple')
ax1.grid(ls='--')
...
x_labels1 = ['73.04','146.08','219.12','292.16']
ax1.set_xticklabels(x_labels1)
ax1.set_title('(a)',size=19)
    
path=r"C:\Users\Yoiz Nuñez\Documents\DOUTORADO 2023\Plot - ALE - Macrocell\ALE-d.csv"
df = pd.read_csv(path)
#d
ax2.plot(df['ale_d_bin_s2'],df['ale_d_value_s2'],"-.", label ='2',lw=3,color='red')
ax2.plot(df['ale_d_bin_s3'],df['ale_d_value_s3'],"--", label ='3',lw=3,color='green')
ax2.plot(df['ale_d_bin_s4'],df['ale_d_value_s4'],":", label ='4',lw=5,color='orange')
ax2.plot(df['ale_d_bin_s5'],df['ale_d_value_s5'],"x-", label ='5',lw=3,color='brown')
ax2.plot(df['ale_d_bin_s6'],df['ale_d_value_s6'], label ='6',lw=3,color='purple')
ax2.grid(ls='--')
...
x_labels2 = ['885.53','1771.06','2656.59','3542.12']
ax2.set_xticklabels(x_labels2)
ax2.set_title('(b)',size=19)

path=r"C:\Users\Yoiz Nuñez\Documents\DOUTORADO 2023\Plot - ALE - Macrocell\ALE-f.csv"
df = pd.read_csv(path)
#f
ax3.plot(df['ale_f_bin_s3'],df['ale_f_value_s3'],"--", label ='3',lw=3,color='green')
ax3.plot(df['ale_f_bin_s4'],df['ale_f_value_s4'],":", label ='4',lw=5,color='orange')
ax3.plot(df['ale_f_bin_s5'],df['ale_f_value_s5'],"x-", label ='5',lw=4,color='brown')
ax3.plot(df['ale_f_bin_s6'],df['ale_f_value_s6'], label ='6',lw=4,color='purple')
ax3.grid(ls='--')
...
x_labels3 = ['0','0.75','2.5','3.5']
ax3.set_xticklabels(x_labels3)
ax3.set_title('(c)',size=19)

path=r"C:\Users\Yoiz Nuñez\Documents\DOUTORADO 2023\Plot - ALE - Macrocell\ALE-gh.csv"
df = pd.read_csv(path)

#gh
ax4.plot(df['ale_gh_bin_s4'],df['ale_gh_value_s4'],":", label ='4',lw=5,color='orange')
ax4.plot(df['ale_gh_bin_s5'],df['ale_gh_value_s5'],"x-", label ='5',lw=3,color='brown')
ax4.plot(df['ale_gh_bin_s6'],df['ale_gh_value_s6'], label ='6',lw=3,color='purple')
ax4.grid(ls='--')
...
x_labels4 = ['10.84','15.92','21.0','26.09']
ax4.set_xticklabels(x_labels4)
ax4.set_title('(d)',size=19)

path=r"C:\Users\Yoiz Nuñez\Documents\DOUTORADO 2023\Plot - ALE - Macrocell\ALE-ah.csv"
df = pd.read_csv(path)
#ah
ax5.plot(df['ale_ah_bin_s5'],df['ale_ah_value_s5'],"x-", label ='5',lw=3,color='brown')
ax5.plot(df['ale_ah_bin_s6'],df['ale_ah_value_s6'], label ='6',lw=3,color='purple')
ax5.grid(ls='--')
...
x_labels5 = ['47.56','55.55','63.54']
ax5.set_xticklabels(x_labels5)
ax5.set_title('(e)',size=19)

path=r"C:\Users\Yoiz Nuñez\Documents\DOUTORADO 2023\Plot - ALE - Macrocell\ALE-vd.csv"
df = pd.read_csv(path)

#vd
ax6.plot(df['ale_vd_bin_s6'],df['ale_vd_value_s6'], label ='6',lw=3,color='purple')
ax6.grid(ls='--')
...
x_labels6 = ['0','70.19','140.38','210.57','280.76']
ax6.set_xticklabels(x_labels6)
ax6.set_title('(f)',size=19)
...
fig.tight_layout()
plt.savefig('ALE-GTB-macro-cov.eps',format='eps',dpi=600)
plt.show()
plt.close()
