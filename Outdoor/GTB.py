...
ax1.set_xlabel('$d$ (m)',fontsize=22)
ax1.set_ylabel('Centered ALE',fontsize=22)
...
ax2.set_xlabel('$f$ (GHz)',fontsize=22)
...
ax3.set_xlabel('$v_{depth}$ (m)',fontsize=22)
#ax3.set_title('(c)', fontsize=22)
...
ax4.set_xlabel('$\Delta_h$ (m)',fontsize=22)
#ax4.set_title('(d)', fontsize=22)
