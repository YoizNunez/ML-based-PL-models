...
X_train = df_train.iloc[:, [13,14,16,17]] #13,14,16,17
...
gtb_regressor =  SVR(kernel='rbf', C=65, epsilon=0.0001,gamma=0.02)
...
gtb_regressor =  SVR(kernel='rbf', C=75, epsilon=0.0001,gamma=0.02)  
