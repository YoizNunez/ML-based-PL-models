...
gtb_regressor = GradientBoostingRegressor(n_estimators=58, learning_rate=0.14, max_depth=11, min_samples_leaf=10, alpha=0.9, random_state=42, loss='absolute_error', max_features='auto')
gtb_regressor.fit(X_train, np.ravel(y_train))
